...
public class Paging {
		...
		private int stno;			// db 시작 
		private int endno;			// eb end
		...
		private void makePaging() {
			...
			this.endno = this.pageNo * this.pageSize;
			this.stno = this.endno - this.pageSize ;
		...
		public HashMap<String,String> setting(int pageNo, int pageSize, int totalcnt, HashMap<String,String> paramMap)
		{
			...
			paramMap.put("startNo", String.valueOf(this.stno));
			paramMap.put("rows", String.valueOf(this.pageSize));
			return paramMap;
		}
