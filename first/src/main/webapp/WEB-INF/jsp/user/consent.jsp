...
제1조(목적)
이 약관은 OpenSoSo(이하 "단체"라 한다) 홈페이지(www.rocy.com)에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
...
(시행일) 이 약관은 2014년 5월 1일부터 시행합니다.
										...
										<div class="row text-left">
											<div class="col-xs-12 col-sm-3">
												<input type="radio" id="joinCk" name="joinCk" value="Y"> 동의 합니다.
											</div>
											<div class="col-xs-12 col-sm-3">
												<input type="radio" id="joinCk" name="joinCk" value="N"> 동의 하지 않습니다.
											</div>
										</div>
									</div>
								</div>
...
신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)
									...
									<div class="row text-left">
										<div class="col-xs-12 col-sm-3">
											<input type="radio" id="ssnCk" name="ssnCk" value="Y"> 동의 합니다.
										</div>
										<div class="col-xs-12 col-sm-3">
											<input type="radio" id="ssnCk" name="ssnCk" value="N"> 동의 하지 않습니다.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="allCheck btn btn-default">
								<i class="fa fa-bolt fa-lg"></i> 전체동의
							</div>
